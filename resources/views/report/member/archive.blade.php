...
@section('page_title') Archived Members @Stop
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"> 
                                        <form method="POST", action="{{ route('m.restore', $member['slug']) }}">
                                            {{method_field('POST')}}
                                            {{csrf_field()}}
                                            <button type="submit" id="deleteTrigger" class="btn btn-sm btn-warning btn-outline-danger mr-2" onclick="return confirm('Are you sure to restore archived');"><i class="fal fa-exchange"></i> Restore</button>
                                        </form>
                                    </td>
                                </tr>
                            @empty
