...
@section('page_title') Members Absent @Stop
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(empty($item->photo))
                                            ...
                                            @endif
                                        @else
                                            <img src="{{URL::to($item->photo)}}" class="img rounded-circle " height="30" width="30" alt="{{ $item['fullname']}}">
                                        @endif
                                        {{ $item['fullname'] }}
                                    </td>
                                    <td>{{ $item['tel'] }}</td>
