...
@section('page_title') Feedback Analysis @Stop
    ...
    <div class="d-flex flex-grow-1 p-0 shadow-1">
        ...
        <div class="d-flex flex-column flex-grow-1 bg-white">
            <div class="p-2">
                ...
                <div class="content-panel">
                    <table id="dt-basic-comments" class="table table-bordered table-hover table-striped w-100">
                        <thead>
                            <tr>
...
<script>
    anychart.onDocumentReady(function() {
        ...
        commentChart.data(commentData, {
            mode: "byWord",
            maxItems: 150,
            ignoreItems: ["the", "and","he","or", "of","in","thy", 'self', 'yourself', 'myself', 'i', 'my','that', 'will', 'all', 'by', 'as', 'our', 'to', 'for']
        });

        commentChart.angles([0]);
        commentChart.title('Feedback Analysis (Most occurence word)');
