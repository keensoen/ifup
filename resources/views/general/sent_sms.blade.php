...
@section('page_title') Sent SMS @Stop
        ...
        <div class="d-flex flex-column flex-grow-1 bg-white">
            <div class="p-2">
                ...
                <div class="content-panel">
                    <table id="dt-basic-sent-sms" class="table table-bordered table-hover table-striped w-100">
                        <thead>
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(!is_null($item['sms_template_id']) || !empty($item['sms_template_id']))
                                            ...
                                            <br/> 
                                            <span class="badge badge-success">{{ date('d-m-Y h:m:s', strtotime($item['created_at'])) }}</span>
                                        @else
                                            {{ $item['content'] }} 
                                            <br/>
                                            <span class="badge badge-success">{{ date('d-m-Y h:m:s', strtotime($item['created_at'])) }}</span>
