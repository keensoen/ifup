...
@section('page_title') External SMS @Stop
        ...
        <div class="d-flex flex-column flex-grow-1 bg-white">
            <div class="p-2">
                ...
                <div class="content-panel">
                    <table id="dt-basic-external" class="table table-bordered table-hover table-striped w-100">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @forelse ($logs as $i => $item)
                                <tr>
                                    <td width="3">{{ ++$i }}</td>
                                    <td>{{ $item->organization['parish'] }}</td>
                                    <td>{{ $item->number }}</td>
                                    <td>{{ $item->content }}</td>
