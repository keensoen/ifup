<header class="page-header" role="banner">
    ...
    <div class="page-logo">
        <a href="javascript:void(0);" class="page-logo-link press-scale-down d-flex align-items-center position-relative">
            <img src="{{ URL::to('img/logo.png') }}" width="50" height="50" alt="iFollowUP" aria-roledescription="logo">
    ...
    <div class="search">
        <form class="app-forms hidden-xs-down" role="search" action="{{route('comrades.index')}}" autocomplete="off">
            <input type="text" id="search-field" placeholder="Search for Members" name="q" class="form-control" tabindex="1">
            <a href="{{route('comrades.index')}}" onclick="return false;" class="btn-danger btn-search-close js-waves-off d-none" data-action="toggle" data-class="mobile-search-on">
    ...
    <div class="ml-auto d-flex">
        ...
        <div>
            <a href="#" data-toggle="dropdown" title="" class="header-icon d-flex align-items-center justify-content-center ml-2">
                <img src="{{ URL::to('img/demo/avatars/avatar-admin.png') }}" class="profile-image rounded-circle" alt="">
            </a>
