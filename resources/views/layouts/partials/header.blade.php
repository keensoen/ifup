<header class="page-header" role="banner">
    ...
    <div class="search">
        <form class="app-forms hidden-xs-down" role="search" action="{{route('members.index')}}" autocomplete="off">
            <input type="text" id="search-field" placeholder="Search for Members" name="q" class="form-control" tabindex="1">
            <a href="{{route('members.index')}}" onclick="return false;" class="btn-danger btn-search-close js-waves-off d-none" data-action="toggle" data-class="mobile-search-on">
